...
$presentations = $db->query($query) or die($db->error . __LINE__);
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['delete_id'])) {
        $id = $_POST['delete_id'];
        $query = "SELECT COUNT(*) as total FROM articulo WHERE presentacion_id=$id;";
        ...
        if ($foreignkeys['total'] == 0) {
            ...
            $error = '<div class="alert alert-dismissable alert-warning"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
              <h4><i class="icon fa fa-warning"></i>¡Atención!</h4>  Esa presentación esta relacionado con al menos un artículo, no puede ser eliminado.</div>';
        }
    }
}
?>
    ...
    <section class="content">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="container">
                    <div class="row">
                        <a class="btn btn-primary" href="create/">Registrar Presentación</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="box">
                    ...
                    <div class="box-header">
                        <h3 class="box-title"><strong>Lista de Presentación</strong></h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <table id="list_sales" class="table table-striped table-bordered dt-responsive nowrap"  width="100%">
                            ...
                            <tbody>
                                <?php $i = 1;
                                while ($row = $presentations->fetch(PDO::FETCH_ASSOC)):
                                    ?>
                                    <tr>                                
